        ...
        <div class="col-md-5 mx-auto">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-44 p-b-54">
				<form method="POST" enctype="multipart/form-data" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "A ESPB is required">
						<span class="label-input100-1">ESPB</span>
					...
					<div class="container-login100-form-btn p-t-44">
						<div class="wrap-login100-form-btn">
							...
							<button onclick='addSubject()' class="login100-form-btn" name="add" type="submit" id="add" value="Add Wizard">
								Add Subject
							</button>
						</div>
					</div>
...
<!--===============================================================================================-->
    ...
    document.getElementById("add").onclick = function () {
        location.href = "/phpProject/add.php";
    };
</script>
